...
require_once 'IKL/Domain/Account/Household/EDO/Interface.php';

/**
 * @access private
 */
class DomainTest_Mock_Account_Household_EDO
	extends DomainTest_Mock_EDO_Abstract
	implements IKL_Domain_Account_Household_EDO_Interface
{
	/**
	 * Constructor
	 */
