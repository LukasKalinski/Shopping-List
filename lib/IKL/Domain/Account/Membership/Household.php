 ...
 * @access public
 */
abstract class IKL_Domain_Account_Membership_Household
	extends IKL_Domain_Account_Membership_Abstract
{
	/**
	 * Creates a membership of a household account.
	 * 
   ...
   * 
   * @param IKL_Domain_Account_Membership_Permission_Household $permission
   * @return void
   */
  public function addPermission(
  	IKL_Domain_Account_Membership_Permission_Household $permission)
  {
